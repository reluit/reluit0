        ...
        >
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
            ...
            <div className="flex justify-end">
              <Link href="/dashboard/evaluate" className="px-4 py-2 text-sm font-medium text-gray-700 border border-gray-200 rounded-full bg-white hover:bg-gray-50 transition-colors flex items-center gap-2">
                View calls
